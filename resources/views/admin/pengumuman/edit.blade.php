<title>Dashboard | Edit Pengumuman</title>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea name="deskripsi"
                        ...
                        placeholder="Isi pengumuman...">{{ old('deskripsi', $pengumuman->deskripsi) }}</textarea>
              @error('deskripsi')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="date"
                         ...
                         value="{{ old('tanggal_selesai', $pengumuman->tanggal_selesai) }}">
            ...
            <div class="form-group">
              ...
              <select name="status"
                ...
                <option value="berakhir"
                  {{ old('status', $pengumuman->status) == 'berakhir' ? 'selected' : '' }}>
                  Berakhir
                </option>
              </select>
              @error('status')
